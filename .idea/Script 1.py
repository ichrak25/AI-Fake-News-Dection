...
# Load dataset
input_file_path = r"D:\Ichrak\SUPCOM\AI Project\Dirty Dataset\Fake.csv"  # Path to the input CSV
...
output_file_path = os.path.join(output_dir, "cleaned_text_dataset.csv")
